...
void setup() {
  ...
  client2.setServer(mqtt_server_pil1, 1883);
  client2.setCallback(callback);
  client2.subscribe("server-arduino2");
  client.subscribe("server-arduino1");
}
...
//    Serial.print("Attempting MQTT connection...");
    // Create a random client ID
      if (client.connect("ESP32")) {
        Serial.print("connected to 1");
        client.subscribe("server-arduino1");
      }
//    else if(client2.connected()){
//      if (client2.connect("ESP322")) {
//        Serial.print("connected to 2");
//        client.subscribe("server-arduino2");
//      }
//    } 
...
//      } else {
//        Serial.p/rint("connected to 1");
//        Serial.println(mqtt_server_pil2);
//      }
      // Once connected, publish an announcement...
//      client.subscribe(/"server-arduino1");
//      client.subscribe("failover");
//    } else if (client2./connect("ESP322")) {
//      if (switcher == 1) {
//        Serial.print("connected to ");
//        Serial.println(mqtt_server_pil1);
//      } else {
//        Serial.prin/t("connected to 2");
//        Serial.println(mqtt_server_pil2);
//      }
      // Once connected, publish an announcement...
//      client2.su/bscribe("server-arduino2");
//      client.subscribe("failover");
     else {
